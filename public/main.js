...
var AddlistingComponent = /** @class */ (function () {
    ...
    AddlistingComponent.prototype.submititem = function () {
        ...
        this._userservice.addnewbookitem(list).subscribe(function (mymsg) {
            console.log(mymsg);
            if (mymsg === 'successfully added new list item') {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.verifyaccount = function () {
        ...
        this._userservice.verifyuser(user).subscribe(function (user) {
            mymsg = user;
            console.log(mymsg);
            if (mymsg === "Id Password Match Successfully") {
                _this._userservice.setemail(_this.email);
                console.log(_this._userservice.getemail());
                _this.router.navigate(['/listing']);
            }
            else {
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.signup = function () {
        ...
        this._userservice.adduser(user).subscribe(function (mymsg) {
            console.log(mymsg);
            if (mymsg === 'successfully added new user') {
...
module.exports = "<app-navbar></app-navbar>\n<div class=\"container\" style=\"background-color: #E9F4FB; padding: 80px; margin: 50px auto;border-radius:15px \">\n\n    <h1 class=\"my-4\">{{listitem.book}}\n      <small>({{listitem.author}})</small>\n    </h1>\n\n    <div class=\"row\">\n\n      <div class=\"col-md-8\">\n        <img class=\"img-fluid\" [src]=\"listitem.image\" alt=\"\">\n      </div>\n\n      <div class=\"col-md-4\">\n        <h3 class=\"my-3\">{{listitem.description}}</h3>\n        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae. Sed dui lorem, adipiscing in adipiscing et, interdum nec metus. Mauris ultricies, justo eu convallis placerat, felis enim.</p>\n        <h4 class=\"my-4\">Seller Name</h4>\n        <h5><i class=\"fas fa-mobile-alt fa-spin\"></i>   (Seller Number)</h5>\n        <h2 class=\"my-3\"><i class=\"fas fa-rupee-sign\"></i> Price</h2>\n        \n        <button class=\"btn btn-primary btn-sm\" style=\"margin: 5px\" (click)=\"addtowishlist()\" ><i class=\"fas fa-heart fa-spin\" ></i>  Add To WishList</button>\n        <button class=\"btn btn-primary  btn-sm\" style=\"margin: 5px\"><i class=\"fas fa-comment \" ></i>  Chat With Seller</button>\n      </div>\n      \n    </div>\n  </div>\n\n  <footer class=\"py-5 bg-dark\" style=\"margin-top: 100px\">\n    <div class=\"container\">\n      <p class=\"m-0 text-center text-white\">Copyright &copy; Your Website 2018</p>\n    </div>\n  </footer>\n"
...
var SpecificListingComponent = /** @class */ (function () {
    ...
    SpecificListingComponent.prototype.addtowishlist = function () {
        ...
        this._userservice.addtowishlist(this.listitem.id).subscribe(function (mymsg) {
            console.log(mymsg);
            if (mymsg === 'successfully added to wishlist') {
                _this.router.navigate(['/listing']);
            }
        });
    };
...
module.exports = __webpack_require__(/*! /Users/vijaygarg/Desktop/personal stuff/webdevelopment/practise/bootcamp/BookResselerFrontEnd/frontend/src/main.ts */"./src/main.ts");
